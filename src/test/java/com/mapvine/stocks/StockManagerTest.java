...
public class StockManagerTest {
    ...
    public void testManagerHappyPath() {
        ...
        assertEquals("Should have ten shares of AAPL", 10, unit.numberOfStocksByTicker("aAPl"));
        assertEquals("Should twenty-five shares of GOOG", 25, unit.numberOfStocksByTicker("goog"));
        assertEquals("Should zero shares of AMZN", 0, unit.numberOfStocksByTicker("AMZN"));
        ...
        assertEquals("Should have sold some GOOG", 19, unit.numberOfStocksByTicker("goog  "));
